...
# Process1.0: we ransac method to complete
# Input your room's pair file path, output the transformation
...
if __name__ == "__main__":
    ...
    source_path = "/Users/apple/Downloads/0_room_0.ply"
    target_path = "/Users/apple/Downloads/1_room_2.ply"

    voxel_size = 0.05 # means 5cm for this dataset
    source, target, source_down, target_down, source_fpfh, target_fpfh = prepare_dataset(voxel_size, math.pi, source_path, target_path)
